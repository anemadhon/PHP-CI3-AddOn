...
class Wopos_model extends CI_Model {
	...
	public function getDataWoVendor_Header($fromDate='', $toDate='', $status='', $length,$start){
		...
		$this->db->select('a.id_prodpos_header, a.id_prodpos_plant, a.posting_date, a.prodpos_no, a.plant, a.plant_name, a.storage_location, a.storage_location_name, a.created_date, a.kode_paket, a.nama_paket, a.qty_paket, a.status, a.id_user_input, a.id_user_approved, 
		a.id_user_cancel, a.filename, a.lastmodified, a.num, a.uom_paket, a.back, a.rav_order_id, a.rav_order_date, a.void_status, a.prodpos_no1, a.doc_issue,
		b.doc_issue,
