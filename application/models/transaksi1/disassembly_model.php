...
class Disassembly_model extends CI_Model {
	...
	public function getDataWoVendor_Header($fromDate='', $toDate='', $status=''){
		...
		$this->db->select('a.id_disassembly_header, a.id_disassembly_plant, a.posting_date, a.disassembly_no, a.plant, a.plant_name, a.storage_location, a.storage_location_name, a.created_date, a.kode_paket, a.nama_paket, a.qty_paket, a.status, a.id_user_input, a.id_user_approved, 
		a.id_user_cancel, a.filename, a.lastmodified, a.num, a.uom_paket, a.back, a.disassembly_no1, a.doc_issue,
		b.doc_issue,
