	...
	<?php $this->load->view("_template/nav.php")?>
				...
				<div class="content">
                        ...
                        <div class="card-body">
                            <form action="#" method="POST">
                                <div class="row">
                                    <div class="col-md-12">
                                        <fieldset>
                                            <legend class="font-weight-semibold"><i class="icon-reading mr-2"></i>Work Order Report</legend>
					...
					<div class="card hide">
						<div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-list mr-2"></i>List of Work Order</legend>
		...
		function showDataList(){
			...
			dataTable = $('#tblReportInventory').DataTable({
				...
				"searching":true,
				"ajax": {
					"url":"<?php echo site_url('report/wo/showAllData');?>",
					"type":"POST",
		...
		function printExcel(){
			...
			const arrTDate = tDate.split('-');
			const toDate = arrTDate[0]+arrTDate[1]+arrTDate[2];
			const uri = "<?php echo base_url()?>report/wo/printExcel/?frmDate="+fromDate
																	+"&toDate="+toDate
																	+"&type="+type
			window.location= uri;
		}
