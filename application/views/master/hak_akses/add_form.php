												...
												<div class="col-6">
													...
													if($perms !== FALSE):
														...
														foreach ($perms->result_array() as $perm) {
															...
															echo form_checkbox('perm['.$perm['cat_id'].'_'.$perm['perm_order_id'].']', 
															$perm['category_code'].sprintf("%02d", $perm['perm_code']), 
															$perm_content, 
															$this->lang->line('perm_opt_'.$perm['perm_name']), 'id=perm[]'). 
															$this->lang->line('perm_opt_'.$perm['perm_name']) . "<br />";
