                ...
                <?php if ($this->session->flashdata('success')): ?>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-search4 mr-2"></i>Search of BOM Subtitution & Alternative</legend>  
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <legend class="font-weight-semibold"><i class="icon-list mr-2"></i>List of BOM Subtitution & Alternative</legend>
                            <a href="<?php echo site_url('transaksi1/bomsubalt/add') ?>" class="btn btn-primary"> Add New</a>
        ...
        <script>
            ...
            function showDataList(){
                ...
                dataTable = $('#tableWhole').DataTable({
                    ...
                    "ajax": {
                        "url":"<?php echo site_url('transaksi1/bomsubalt/showListData');?>",
                        "type":"POST",
                        "data":{fDate: fromDate, tDate: toDate, stts: status}
                    },
                    "columns": [
                        {"data":"id_bom_subalt_header", "className":"dt-center", render:function(data, type, row, meta){
                            rr=`<input type="checkbox" class="check_delete" id="chk_${data}" value="${data}" onclick="checkcheckbox();">`;
                            return rr;
                        }},
                        {"data":"id_bom_subalt_header", "className":"dt-center", render:function(data, type, row, meta){
                            rr = `<div style="width:100px">
                                    <a href='<?php echo site_url('transaksi1/bomsubalt/edit/')?>${data}' ><i class='icon-file-plus2' title="Edit"></i></a>&nbsp
                                    <a href='<?php echo site_url('transaksi1/bomsubalt/printXls/')?>${data}' target="_blank"><i class='icon-printer' title="Print Xls"></i></a>&nbsp
                                </div>`;
                            return rr;
                        }},
                        {"data":"id_bom_subalt_header", "className":"dt-center"},
                        {"data":"raw_mat", "className":"dt-center"},
                ...
                $("#deleteRecord").click(function(){
                    ...
                    if(deleteidArr.length > 0){
                        ...
                        if(confirmDelete == true){
                            $.ajax({
                                url:"<?php echo site_url('transaksi1/bomsubalt/deleteData');?>", //masukan url untuk delete
                                type: "post",
