									...
									<div class="col-md-12">
										<fieldset>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													<input type="text" class="form-control" id="prodCostNo" value="<?php echo $pc['prod_cost_no'] ?>" readOnly>
												</div>
											</div>
											...
											<div class="form-group row">
												...
												<div class="col-lg-9">
													...
													<input type="hidden" id="userInput" value="<?php echo $pc['user_input'] ?>">
												</div>
											</div>
											...
											<div class="text-right" id="after-submit" style="display: none;">
												...
												<?php elseif($pc['status'] == 2 && $this->auth->is_have_perm('auth_approve') && $pc['status_head'] !== 0 && $this->auth->is_head_dept()['head_dept'] == $pc['user_login'] && $isUser !== 0) : ?>
													...
													<?php endif; ?>
													<?php if($pc['product_type'] == 2 && $pc['status'] == 2 && $pc['status_head'] == 2 && $this->auth->is_head_dept()['head_dept'] == $pc['user_login'] && strtolower($pc['category_approver']) == strtolower($pc['username_login']) && $pc['status_cat_approver'] == 1) : ?>
														<button type="button" class="btn btn-danger" name="reject" id="reject" data-toggle="modal" data-target="#exampleModal" data-backdrop="static">Reject<i class="icon-paperplane ml-2"></i></button>	
